 ...
 * puedan cargar peliculas. Para esto,
tendremos una clase Pelicula con el título, director y duración 
...
Pelicula pidiéndole al usuario
...
• Ordenar las películas de acuerdo a su duración (de mayor 
a menor) y mostrarlo en
pantalla.

• Ordenar las películas de acuerdo a su duración (de menor a
 mayor) y mostrarlo en
pantalla.

• Ordenar las películas por título, alfabéticamente y mostrarlo 
en pantalla.
...
import Colecciones.Ejercicio4.Service.ServicePelicula;
